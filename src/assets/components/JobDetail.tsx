...
export default function JobDetail({
  ...
  return (
    <div
      id="main"
      className={`absolute transition-all duration-300 flex justify-start items-center px-10 z-12  ${togglestyle} starting:scale-70 ease-in-out
         `}
    >
      <div className="  flex flex-col  justify-start items-center gap-2 mx-2 ">
        <div className="flex justify-center items-center flex-col  rounded-2xl    bg-white border-5 border-double border-rose-200 uppercase text-lg p-3 pb-2 mb-5  slowbounce font-light ">
          <div className="border-rose-100   text-xl border-1  px-3 py-1 rounded-xl font-normal ">
            {jobItem?.title}
          </div>
          {jobItem?.company}
        </div>
        {/* <div className="jobDetailsBox px-6 py-1">{jobItem?.company}</div> */}
        <div className="jobDetailsBox px-6 py-1  rounded-2xl mx-10  bg-white gap-3  text-gray-700 text-sm  ">
        ...
        <div className="w-full flex justify-center gap-1 flex-wrap border-1 bg-white jobDetailsBox pb-1 ">
        ...
        <div
          ...
          w-full text-center text-[10pt] font-light p-4 mt-2"
        >
          {jobItem?.description}
        </div>
        <div className="w-full rounded-2xl mx-10 mt-2  bg-white border-1 border-pink-200">
